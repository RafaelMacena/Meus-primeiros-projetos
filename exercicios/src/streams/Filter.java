...
public class Filter {
	...
	public static void main(String[] args) {
		...
		Function<Aluno, String> saudacaoProvado = a -> "Parabéns " + a.nome + " ! Voce foi aprovado(a)!!";

		alunos.stream().filter(aprovado).map(saudacaoProvado).forEach(System.out::println);
